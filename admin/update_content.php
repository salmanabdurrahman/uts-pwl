...
if (isset($_GET['id'])) {
    ...
    $articleQuery = "SELECT * FROM articles WHERE article_id = ?";
    ...
    $_SESSION['error'] = "Article ID not found.";
    header('Location: ../pages/error.php');
    exit();
}
                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7">
                    <div class="mb-8">
                        ...
                        <p class="text-sm text-gray-600">
                            Update your existing content, such as news, articles, or blog posts.
                        </p>
                    </div>
                    <form action="../actions/update_content.action.php" method="POST" enctype="multipart/form-data">
                        <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                            ...
                            <div class="sm:col-span-9">
                                <input id="title" type="text"
                                    ...
                                    name="title" placeholder="Your title here" value="<?php echo $title; ?>">
                            </div>
                            <div class="sm:col-span-3">
                            ...
                            <div class="sm:col-span-9">
                                <textarea id="short-description" name="short_description"
                                    ...
                                    placeholder="Your short description here"><?= htmlspecialchars($short_description) ?></textarea>
                            </div>
                            <div class="sm:col-span-3">
                            ...
                            <div class="sm:col-span-9">
                                <textarea id="content" name="content"
                                    class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    placeholder="Your content here"><?= htmlspecialchars($content) ?></textarea>
                            </div>
                            <div class="sm:col-span-3">
                            ...
                            <div class="sm:col-span-9">
                                ...
                                file:me-4
                                file:py-2 file:px-4
                                dark:file:bg-neutral-700 dark:file:text-neutral-400" value="<?php echo $imageUrl; ?>">
