                        ...
                        <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                            ...
                            <div class="sm:col-span-9">
                                <input id="username" type="text"
                                    class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg disabled:opacity-50 disabled:pointer-events-none bg-gray-100 cursor-not-allowed focus:ring-0 hover:ring-0 hover:outline-none focus:ring-none focus:shadow-none focus:outline-none focus:border-gray-200 disabled:bg-gray-200"
