...
<body class="font-inter text-base font-normal">
    ...
    <section class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="max-w-2xl text-center mx-auto mb-10 lg:mb-14">
            <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">All News</h2>
            <p class="mt-1 text-gray-600 dark:text-neutral-400">This is a collection of all the news we have.</p>
        </div>
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 items-center justify-center">
            ...
            <button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none mt-6 mx-auto col-span-3">Load more</button>
        </div>
    </section>
    <!-- card blog -->
    <!-- subscribe -->
