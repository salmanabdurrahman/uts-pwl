...
<body class="font-inter text-base font-normal">
    ...
    <section class="max-w-[512px] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="text-center py-10 px-4 sm:px-6 lg:px-8">
            <h1 class="text-[72px] font-bold text-gray-800 sm:text-9xl dark:text-white">404</h1>
            ...
            <div class="mt-5 flex flex-col justify-center items-center gap-2 sm:flex-row sm:gap-3">
                <a class="w-full sm:w-auto py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="../pages/home.php">
